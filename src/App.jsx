...
const serviceItems = [
  {
    ...
    description: 'Native and cross-platform apps crafted for performance, usability, and scale.',
    icon: 'APP',
  },
  {
    title: 'Web Application',
    description: 'Responsive web experiences engineered for reliability, accessibility, and speed.',
    icon: 'WEB',
  },
  {
    title: 'Backend Services',
    description: 'Robust APIs and microservices powering secure, modular digital ecosystems.',
    icon: 'API',
  },
  {
    title: 'AWS Deployment',
    description: 'Cloud-native architectures on AWS with automated provisioning and monitoring.',
    icon: 'AWS',
  },
  {
    title: 'AI Chat-Bots',
    description: 'Intelligent conversational agents delivering instant support and lead capture.',
    icon: 'BOT',
  },
  {
    title: 'Digital Marketing',
    description: 'Full-funnel growth strategies spanning SEO, paid media, and performance analytics.',
    icon: 'DM',
  },
  {
    title: 'Hosting Services',
    description: 'Managed hosting with proactive security, backups, and 24/7 infrastructure care.',
    icon: 'HOST',
  },
]
...
const teamMembers = [
  {
    name: 'Karthik K',
    role: 'Founder & CEO',
    bio: 'Strategic leader with 15+ years driving digital transformation across industries.',
  },
  {
    name: 'Manaswini M',
    role: 'Backend Developer',
    bio: 'Architect of resilient platforms delivering seamless customer experiences.',
  },
  {
    name: 'Umesh R',
    role: 'Frontend Developer',
    bio: 'Cloud-native advocate specializing in Kubernetes, observability, and CI/CD.',
  },
  {
    name: 'Kalpana M',
    role: 'Frontend Developer',
    bio: 'Human-centered strategist shaping digital experiences that delight users.',
  },
  {
    name: 'Thriloak M',
    role: 'Marketing',
    bio: 'Driving AI-first solutions that deliver measurable business outcomes.',
  },
  {
    name: 'Sreeja K',
    role: 'Marketing',
    bio: 'Guardian of zero-trust architectures and enterprise-grade compliance.',
  },
]
...
const contactInitialState = {
  name: '',
  email: '',
  countryCode: countryDialCodes.find((item) => item.code === 'IN')?.dial ?? '+91',
  phone: '',
  message: '',
}
...
function App() {
  ...
  useEffect(() => {
    if (prefersReducedMotion || isCarouselHovered) {
      return
    }
    const id = window.setInterval(() => {
      setActiveLeader((prev) => (prev + 1) % teamMembers.length)
    }, 4000)
    return () => window.clearInterval(id)
  }, [prefersReducedMotion, isCarouselHovered])
  ...
  const cycleLeaders = (direction) => {
    setActiveLeader((prev) => (prev + direction + teamMembers.length) % teamMembers.length)
  }
    ...
    <div className="app-shell">
      <header className={`site-header ${isScrolled ? 'site-header--scrolled' : ''}`}>
        <div className="container header-content">
          <div className="brand" onClick={() => handleNavClick('home')}>
            <img src={brandLogo} alt="Karthiwini Solutions logo" className="brand-mark" />
      ...
      <main>
        <section id="home" className="hero-section" data-animate>
          <div className="container hero-content">
            <div className="hero-text">
              <span className="hero-badge">Trusted IT Transformation Partner</span>
              <h1>
                Building Intelligent Digital Platforms for the Modern Enterprise
              </h1>
              <p>
                Karthiwini Solutions helps visionaries accelerate innovation with resilient
                engineering, human-centered experiences, and measurable outcomes.
              </p>
        ...
        <section id="about" className="section" data-animate>
          <div className="container section-grid">
            ...
            <h2>About Karthiwini Solutions</h2>
              <p>
                We are a global team of architects, engineers, and strategists who
                partner with organisations to deliver mission-ready software. Our
                approach blends design thinking, modular architecture, and rigorous
                delivery practices to de-risk transformation initiatives and move with
                velocity.
              </p>
            </div>
        ...
        <section id="services" className="section section-alt" data-animate>
          <div className="container">
            ...
            <p className="section-intro">
              We align expertise across strategy, engineering, cloud, and security to
        ...
        <section id="projects" className="section" data-animate>
          <div className="container">
            ...
            <p className="section-intro">
              Partnering with industry leaders to convert ambitious roadmaps into
        ...
        <section id="team" className="section section-alt" data-animate>
          <div className="container">
            ...
            >
              <button
                type="button"
                className="team-carousel__btn team-carousel__btn--prev"
                onClick={() => cycleLeaders(-1)}
              ...
              <div className="team-carousel__track">
                {[-1, 0, 1].map((offset) => {
                  const member =
                    teamMembers[(activeLeader + offset + teamMembers.length) % teamMembers.length]
                  const position =
                    offset === -1 ? 'prev' : offset === 0 ? 'active' : 'next'
                  const initials = member.name
                    .split(' ')
                    .map((part) => part[0])
                    .join('')
                  return (
                    <div key={`${member.name}-${position}`} className={`team-card-shell team-card-shell--${position}`}>
                      ...
                      <div className="team-card-caption">
                        <span className="team-card-caption__name">{member.name}</span>
                        <span className="team-card-caption__role">{member.role}</span>
                      </div>
                    </div>
                  )
                })}
              ...
              <button
                type="button"
                className="team-carousel__btn team-carousel__btn--next"
                onClick={() => cycleLeaders(1)}
            ...
            {prefersReducedMotion && (
              <div className="team-list-fallback">
                {teamMembers.map((member) => (
                  <div key={`${member.name}-fallback`} className="team-card-shell team-card-shell--fallback">
                    <div className="team-card-image">
                      {member.photo ? (
                        <img
                          src={member.photo}
        ...
        <section id="contact" className="section section-alt" data-animate>
          <div className="container contact-layout">
            <div>
              ...
              <p className="section-intro">
                Share your vision and we’ll orchestrate the delivery roadmap—from strategy
                to launch and beyond.
              </p>
              <ul className="contact-highlights">
                <li>
                  <strong>Discovery Workshops:</strong> Insight-driven sessions to baseline
                  requirements.
                </li>
                <li>
                  <strong>Solution Blueprints:</strong> Architecture, timeline, and investment
                  clarity.
                </li>
                <li>
                  <strong>Dedicated Squads:</strong> Cross-functional teams aligned to outcomes.
                </li>
              </ul>
            </div>
            <ContactForm />
      ...
      <footer className="footer">
        ...
        <div className="footer-meta">
          <p>© {new Date().getFullYear()} Karthiwini Solutions. All rights reserved.</p>
        </div>
      </footer>
...
function ContactForm() {
  ...
  const handleSubmit = (event) => {
    ...
    if (Object.keys(validationErrors).length === 0) {
      ...
      formData.append('entry.672366913', `${values.countryCode} ${values.phone}`.trim())
  ...
  return (
    <form className="contact-form" onSubmit={handleSubmit} noValidate>
      ...
      <div className="form-row">
        <label htmlFor="phone">
          Your Mobile Number <span className="required-star" aria-hidden="true">*</span>
        </label>
        <div className="phone-input-wrapper">
          <select
            id="countryCode"
            name="countryCode"
            className={errors.countryCode ? 'input-control input-control--error phone-select' : 'input-control phone-select'}
        ...
        {errors.countryCode && <span className="form-error">{errors.countryCode}</span>}
      ...
      {successState !== 'hidden' && (
        <div className={`form-status form-status--success ${successState === 'visible' ? 'is-visible' : ''}`}>
